          ...
          <div className='row'>
            <div className='col-sm-6'>
              <Well>
                ...
                <input className='form-control' type='text' value={this.state.prodName} name='prodName' onChange={this.onChange} placeholder='Product Name' />
                <label for='usr'>Image :</label>

                <input className='form-control' type='text' value={this.state.stuffImg} name='stuffImg' onChange={this.onChange} placeholder='enter image URL here' />
                <br />
                ...
                <div>
                  <Well>
                    <div>
                      ...
                      <img src={item.stuffImg} width='200' height='200' /><br />
