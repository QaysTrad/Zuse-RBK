      ...
      return (
        <div>
          <div className='container text-center'>
            <button className='btn' onClick={this.recieveMessage}>📩inbox</button>
            <Well>
              <img id='iimg' width='300' height='300' className=' img-circle' src='https://wallpaperbrowse.com/media/images/wUq2AY.jpg' />
              <div className='media-body'>
                <h4 className='media-heading'><b>{this.props.name}</b></h4><br />
