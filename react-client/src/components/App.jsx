...
Finding the right residential waste and recycling solutions provider is an important decision. At Waste Management, we reward that decision by providing a wide range of exceptional services and products.</p>
        ...
        <div id='About' className='container-fluid bg-grey'>
          <div className='container'>
            ...
            <div className='row'>
              <div className='col-sm-4'>
                <span className='glyphicon  glyphicon-tree-conifer logo slideanim' />
              </div>
              <div className='col-sm-8'>
                <h2>About Us</h2><br />
              ...
              <div className='row'>
                <div className='col-md-12'>
                  <div className='form-group'>
                    ...
                    <textarea id='form_message' name='message' className='form-control' placeholder='Message for me *' rows='4' required='required' data-error='Please,leave us a message.' />
                    <div className='help-block with-errors' />
                  </div>
                </div>
                <center>
