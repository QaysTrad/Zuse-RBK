            ...
            <div className='row'>
              <Well>
                ...
                <div className='col-sm-4 input-group'>
                  ...
                  <input className='form-control' type='text' value={this.state.productImg} name='productImg' onChange={this.onChange} placeholder='enter image URL here' />
                </div>
            ...
            { this.state.products.map(item =>
              ...
              <div className='col-sm-4'>
                <div className='panel panel-default' >
                  <div className='panel-heading'>{item.productName} <br /> <p>suplied by {item.name}</p></div>
